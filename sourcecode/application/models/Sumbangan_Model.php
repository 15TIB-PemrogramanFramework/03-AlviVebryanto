...
*/
class Sumbangan_Model extends CI_Model
{
	...
	function sumbangan() 
	{
		$this->db->select('sumbangan.id_anggota,sumbangan.id_sumbangan, anggota.nama, sumbangan.modul, sumbangan.tanggal_sumbangan, sumbangan.jumlah_sumbangan');
